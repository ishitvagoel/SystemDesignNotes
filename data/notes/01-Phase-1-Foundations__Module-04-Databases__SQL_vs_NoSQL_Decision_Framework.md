...
flowchart TD
    ...
    style E fill:var(--surface),stroke:var(--accent),stroke-width:2px;
    style F fill:var(--surface),stroke:var(--accent2),stroke-width:2px;
    style G fill:var(--surface),stroke:var(--border),stroke-width:1px;
    style I fill:var(--surface),stroke:var(--border),stroke-width:1px;
    style J fill:var(--surface),stroke:var(--border),stroke-width:1px;
```
