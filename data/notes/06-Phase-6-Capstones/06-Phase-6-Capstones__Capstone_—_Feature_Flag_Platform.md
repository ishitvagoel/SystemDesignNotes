...
flowchart TD
    ...
    style ControlPlane fill:#f6f8fa,stroke:#2d8a4e,stroke-width:2px
    style DataPlane fill:#f6f8fa,stroke:#0969da,stroke-width:2px
    style Analytics fill:#f6f8fa,stroke:#888,stroke-width:1px
```
